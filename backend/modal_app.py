...
# Define the Modal Image with necessary ML dependencies
...
@app.function(image=image, mounts=[modal.Mount.from_local_file(local_weights_path, remote_path="/weights/best.pt")])
@modal.asgi_app()
def fastapi_app():
