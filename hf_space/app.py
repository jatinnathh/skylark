"""
Skylark GCP Pose Engine — Hugging Face Spaces Backend
FastAPI server that runs YOLO pose detection on uploaded aerial images.
"""
...
# --- FastAPI app ---
app = FastAPI(
    title="Skylark GCP Pose Engine",
    description="YOLO-based Ground Control Point detection API",
    version="2.0",
)
...
async def predict(file: UploadFile = File(...)):
    """
    Run sliding-window YOLO pose detection on an uploaded image.
    Returns the best detection with bounding box, keypoint, class, and annotated image.
    """
    try:
    ...
    if best_conf > 0.0:
        ...
        # Draw predicted keypoint — red X marker
